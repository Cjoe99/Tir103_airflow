...
if __name__ == '__main__':
    ...
    # 連接到 MongoDB
    mongo_client = MongoClient("mongodb://user5:password5@35.189.181.117:28017/admin")  # 替換為你的 MongoDB 連接 URI
    check_mongodb_connection(mongo_client)

    # 獲取資料庫和集合
    db = mongo_client['kafka']  # 替換為你的資料庫名稱
    collection = db['News']  # 替換為你的集合名稱
