...
from tasks.ptt_consumer_task_ckip import kafka_consumer_job  # 匯入已分離的消費者任務函數
from utils.slack_webhook_ptt_ckip import slack_start_callback, slack_failure_callback, slack_success_callback
